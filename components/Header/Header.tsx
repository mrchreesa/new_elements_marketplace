  ...
  return (
    <>
      <Head>
        <link
          rel="preload"
          href="/CarbonGravity-Compressed.woff2"
          as="font"
          type="font/woff2"
        ...
        <link
          rel="preload"
          href="/CarbonGravity-XXCompressed.woff2"
          as="font"
          type="font/woff2"
          crossOrigin="anonymous"
        />
              ...
              >
                <div className="flex  items-center w-full justify-center lg:px-8 sm:items-stretch ">
                  ...
                  <div className="flex  items-center basis-[48%]">
                    <Link href="/">
                      <h1 className="text-4xl md:text-3xl ml-2 md:ml-0 fontCompressed whitespace-nowrap lg:text-dynamicXl font-compressed">
                        NEW ELEMENTS
                      </h1>
                    </Link>
                  </div>
                  ...
                  <div className="basis-[56%] flex  justify-between">
                    <div className=" w-full items-center">
                      <div className="flex">
                        <div className="flex w-full  font-xxCompressed fontxxCompressed items-center justify-end md:justify-between">
                          {navigation.map((item) => (
                            <Link
                              key={item.name}
                              href={item.href}
                        ...
                        <div className="flex mb-1 ml-0 md:ml-[10%] md:mb-0 md:mt-1 justify-center">
                          <ProfileMenu />
                        </div>
                      </div>
                    </div>
